# Contributing to NerdStats

Developer notes for building, testing, releasing and understanding NerdStats. For what the
app does and how to install it, see the [README](README.md).
